...
/*data definition*/
//extern	S_Size<long>            oSystemDisplayResolution;         /*Разрешение экрана*/
...
//////////////////////////////////////////////////////////////////////////
C_CalibrationWindow::C_CalibrationWindow( QWidget* pParent /*= 0 */ )
	: QGLWidget(pParent)
{
	startTimer( 1000 / fps );
}
...
//////////////////////////////////////////////////////////////////////////
void C_CalibrationWindow::initializeGL()
{
	glClearColor(0.42f, 0.7f, 1.0f, 0);
}

//////////////////////////////////////////////////////////////////////////
void C_CalibrationWindow::resizeGL( int iWidth, int iHeight )
{
...
//////////////////////////////////////////////////////////////////////////
void C_CalibrationWindow::paintGL()
{
...
//////////////////////////////////////////////////////////////////////////
void C_CalibrationWindow::keyPressEvent( QKeyEvent* pEvent )
{
...
//////////////////////////////////////////////////////////////////////////
void C_CalibrationWindow::timerEvent( QTimerEvent* pEvent ){
	paintGL();
	updateGL();
}
