    ...
    VideoCaptureMock(int i)
    {
        ...
        _th = thread([=](){
            ...
            while(_thWork){
                ...
                _blackImage = Mat{480, 640, CV_8UC3, Scalar{0, 0, 0}};

                circle(_blackImage, _fakeIr, 3, Scalar{255,255,255}, -1);

                imshow("fake camera image", _blackImage);
